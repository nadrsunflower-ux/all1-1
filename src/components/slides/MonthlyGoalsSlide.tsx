    ...
    <div className="w-full h-full flex flex-col items-center justify-center px-16 py-12">
      ...
      <div className="grid grid-cols-3 gap-10 w-full max-w-[1200px]">
        {goals.map((goal, index) => (
          <AnimatedElement key={index} delay={0.05 + index * 0.05}>
            <motion.div
            ...
            >
              ...
              >
                ...
                <h5 className="text-white text-[1.4rem] font-medium mb-4">{goal.title}</h5>

                <p className="text-[#8892b0] text-base leading-[1.7] whitespace-pre-line">
                  {goal.description}
                </p>

                {goal.subDescription && (
                  <p className="mt-3 text-[#64ffda] text-[0.95rem] leading-[1.5] whitespace-pre-line">
                    {goal.subDescription}
                  </p>
                )}
              </div>
